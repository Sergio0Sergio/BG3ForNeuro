-- BG3NeuroClient.lua v0.8.51 — клиентская половина мода (тикет bg3-neuro-dialogue-click).
...
_G["BG3Neuro_VERSION"] = "0.8.51" -- экспорт для BootstrapClient.lua (правдивый лог загрузки)
